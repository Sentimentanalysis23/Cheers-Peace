        ...
        <div className="relative flex overflow-x-hidden group">
          <div className="animate-marquee whitespace-nowrap flex items-center gap-16 md:gap-24 px-8">
            {[
              ...
              { type: 'image', src: '/images/clients/aeroindia.png', alt: 'AeroIndia' },
              { type: 'image', src: '/images/clients/amitech.png', alt: 'Amitech' },
              { type: 'image', src: '/images/clients/bluestar.png', alt: 'BlueStar' },
              { type: 'image', src: '/images/clients/american_express.png', alt: 'American Express' },
              { type: 'image', src: '/images/clients/cred.png', alt: 'Cred' },
              { type: 'image', src: '/images/clients/jbl.png', alt: 'JBL' },
              { type: 'image', src: '/images/clients/microsoft.png', alt: 'Microsoft' },
              { type: 'image', src: '/images/clients/arkance.png', alt: 'Arkance' },
              { type: 'image', src: '/images/clients/ametek.png', alt: 'AMETEK' },
              { type: 'image', src: '/images/clients/pawan_hans.png', alt: 'Pawan Hans' },
              { type: 'image', src: '/images/clients/roomer.png', alt: 'Roomer' },
              { type: 'image', src: '/images/clients/veka.png', alt: 'VEKA' },
              { type: 'image', src: '/images/clients/epos.png', alt: 'EPOS' },
              { type: 'image', src: '/images/clients/mazagon_dock.png', alt: 'Mazagon Dock' },
              { type: 'image', src: '/images/clients/hal_v2.png', alt: 'HAL' },
              { type: 'image', src: '/images/clients/hp_v2.png', alt: 'HP' },
              { type: 'image', src: '/images/clients/pavilions_v2.png', alt: 'Pavilions and Interiors' },
              { type: 'image', src: '/images/clients/simplilearn_v2.png', alt: 'Simplilearn' },
